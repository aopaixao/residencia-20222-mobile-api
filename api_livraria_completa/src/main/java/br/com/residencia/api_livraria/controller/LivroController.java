...
public class LivroController {
	...
	public ResponseEntity<LivroDTO> saveLivroDTO(@RequestPart("livro") String livro,
			@RequestPart("source") MultipartFile file) throws IOException{
		
		LivroDTO novaLivroDTO = livroService.saveLivro(livro, file); 
		if (null == novaLivroDTO)
			return new ResponseEntity<>(null, HttpStatus.BAD_REQUEST);
		else
			return new ResponseEntity<>(novaLivroDTO, HttpStatus.CREATED);
