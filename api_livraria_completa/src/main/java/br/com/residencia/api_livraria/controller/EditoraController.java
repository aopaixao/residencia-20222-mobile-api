...
public class EditoraController {
	...
	public ResponseEntity<EditoraDTO> saveEditoraDTO(@RequestPart("editora") String editora,
			@RequestPart("source") MultipartFile file) throws IOException{
		
		EditoraDTO novaEditoraDTO = editoraService.saveEditora(editora, file); 
		if (null == novaEditoraDTO)
			return new ResponseEntity<>(null, HttpStatus.BAD_REQUEST);
		else
			return new ResponseEntity<>(novaEditoraDTO, HttpStatus.CREATED);
